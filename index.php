...
<head>
   ...
   <meta name="description"
      content="Doctor on call for home visit in Mumbai at CallaDoctors. Providing quality healthcare services. Visit calladoctors.in.">
         ...
         <div class="row justify-content-center p-4">
            <div class="col-lg-6 col-10 formrow p-4">
               ...
               <form action="contact.php" method="get">
                  ...
                  <div class="form-group">
                     <input type="tel" class="form-control" id="phone" name="phonef1" placeholder="Mobile Number*"
                        required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     <input type="text" class="form-control" id="message" name="messagef1"
                        placeholder="Problem the Patient has right Now/ History of Patients*" required>
                  </div>
            ...
            <div class="row justify-content-center" data-aos="fade-left">
               <div class="col-lg-3 col-md-4 mt-4">
                  ...
                  <p class="quote">"Great experience as a first-timer. I barely waited to be helped when I checked in.
                     ...
                     looking for a <a href="/mumbai.php" target="_blank" rel="noopener noreferrer"
                        class="testimonial-link">doctor for home visit in Mumbai</a>, I highly recommend them."
                  </p>
                  <h5>- Amarlal Yadav</h5>
               </div>
               <div class="col-lg-3 col-md-4 mt-4">
               ...
               <div class="col-lg-3 col-md-4 mt-4">
                  ...
                  <p class="mt-3">"Dr. Gufran did a great job with my first ever health exam. He explained everything to
                     me in a very clear manner. He was also kind and friendly."
                  </p>
               ...
               <div class="col-lg-3 col-md-4 mt-4">
                  ...
                  <p class="mt-3">"Dr. Gufran was terrific. Knowledgeable, sensitive, informative… I immediately felt at
                     ...
                     very impressed w. the overall experience. HIGHLY recommend."
                  </p>
                  <h5>-Rohit Dubey</h5>
               </div>
            </div>
