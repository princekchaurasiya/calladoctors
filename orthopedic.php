            ...
            <div class="container-fluid">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-8 icon-boxes d-flex flex-column align-items-stretch ">
                        ...
                        <p>Our team of experienced orthopedic specialists offers a comprehensive range of services to
                ...
                <div class="row justify-content-center" data-aos="fade-left">
                    <div class="col-lg-3 col-md-4 mt-4">
                        ...
                        <p class="quote">"Great experience as a first-timer. I barely waited to be helped when I
                            checked in.
                            The staff and Dr. Gufran were all very friendly and helpful. I especially loved how Dr.
                            Gufran
                            really took his time to explain my conditions with me as well as my treatment options. If
                            you're
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 mt-2" data-aos="fade-right" data-aos-delay="100">
                        ...
                        <div class="info">
                            <div class="address mt-5">
                                <a href="/jogeshwari.php" target="_blank" rel="noopener noreferrer"
                                    class="testimonial-link"><i class="bi bi-geo-alt"></i>Doctor for home visit in
                                    Jogeshwari</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 mt-2" data-aos="fade-right" data-aos-delay="100">
                        <div class="info">
                            <div class="address">
                                <a href="/andheri.php" target="_blank" rel="noopener noreferrer"
                                    class="testimonial-link"><i class="bi bi-geo-alt"></i>Doctor for home visit in
                                    Andheri</a>
                            </div>
                        </div>
                        <div class="info">
                            <div class="address mt-5">
                                <a href="/malad.php" target="_blank" rel="noopener noreferrer"
                                    class="testimonial-link"><i class="bi bi-geo-alt"></i>Doctor for home visit in
                                    Malad</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 mt-2" data-aos="fade-right" data-aos-delay="100">
                        <div class="info">
                            <div class="address">
                                <a href="/goregaon.php" target="_blank" rel="noopener noreferrer"
                                    class="testimonial-link"><i class="bi bi-geo-alt"></i>Doctor for home visit in
                                    Goregaon</a>
                            </div>
                        </div>
                        <div class="info">
                            <div class="address mt-5">
                                <a href="/santacruz.php" target="_blank" rel="noopener noreferrer"
                                    class="testimonial-link"><i class="bi bi-geo-alt"></i>Doctor for home visit in
                                    Santacruz</a>
                            </div>
                        </div>
    ...
    <div class="fixed-bottom d-md-block d-lg-none">
        <div id="stickymob">
            <div class="row stickybtn">
                <a class="stickywa"
                    href="whatsapp://send?text=Hello Doctor I want to Schedule a Visit&phone=+918657965005">
